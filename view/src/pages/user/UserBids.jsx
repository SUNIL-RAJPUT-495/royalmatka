...
export const UserBids = () => {
  ...
  // Dummy bids (default empty to match screenshot)
  const bids = [];
  ...
  return (
    <div className="w-full select-none pb-8 font-sans">
      ...
      <div className="px-4 space-y-4">
        {/* 2. TWO STATS CARDS: Total Winnings & Total Bets */}
        ...
        {/* 5. NO BETS FOUND / CONTENT LIST */}
        {filteredBids.length > 0 ? (
          <div className="space-y-3">
            {filteredBids.map((bid, idx) => (
              <div key={idx} className="bg-white rounded-3xl p-4 border border-gray-150 shadow-2xs">
                {/* Bid details */}
              </div>
            ))}
          </div>
