        ...
        <div className="flex items-center justify-between">
          ...
          <div className="w-32">
            <input
              ...
              className="w-full h-9 px-3 border rounded-lg text-center font-bold text-sm outline-none bg-white focus:ring-0 shadow-3xs text-gray-800 placeholder-gray-400"
            />
          </div>
        </div>
